...
export const DIAL_FIELDS: FieldSchema[] = [
  ...
  bool('tcp_fast_open', 'TCP Fast Open — ускоренное открытие TCP-соединения.'),
  bool('tcp_multi_path', 'Multipath TCP — соединение по нескольким сетевым путям.'),
...
export const TLS_FIELDS: FieldSchema[] = [
  ...
  obj('ech', 'Шифрование ClientHello (Encrypted Client Hello).', [
