...
/**
 * Подписи вердикта трассировки. 'unknown' у Mihomo — про САМО правило: его
 * условие проверить нечем. Остановка прохода — следствие такого вердикта, а не
 * его смысл (правила ниже выполняются ровно при условии, которого мы не знаем),
 * и подпись обязана говорить о причине, а не о последствии. Отсюда своя
 * формулировка, а не заимствованная у Xray «нет данных».
 */
