    ...
    return (
      <>
        ...
        <p className="muted check-note">
          Проверена структура документа: вместо серверов подставлены фиктивные прокси — настоящие
          хосты подписке подставляет панель, и работоспособность конкретных серверов эта проверка
          не подтверждает.
        </p>
      </>
    )
