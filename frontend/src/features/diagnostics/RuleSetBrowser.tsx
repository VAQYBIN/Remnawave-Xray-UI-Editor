  ...
  return (
    <div className="rs-browser">
      ...
      <div className="rs-pager">
        ...
        {page.data !== undefined && page.data.count !== total && (
          // Числа расходятся у обоих видов набора, и молчать об этом нельзя: у
          // доменов ядро кладёт на каждую запись и сам домен, и форму «+.», у
          // подсетей один диапазон распадается на несколько CIDR. Плюс поиск,
          // который сужает найденное у любого вида. Показываем ровно тогда,
          // когда числа И ПРАВДА разные — иначе подпись была бы шумом
