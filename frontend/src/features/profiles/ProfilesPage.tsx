    ...
    <main className="page">
      ...
      {profiles.isError && (
        <div className="field-error">
          <p>{(profiles.error as Error).message}</p>
          {hintOf(profiles.error) && <p className="field-hint">{hintOf(profiles.error)}</p>}
          {causeOf(profiles.error) && <p className="muted">{causeOf(profiles.error)}</p>}
        </div>
      )}
