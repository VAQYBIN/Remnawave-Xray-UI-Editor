...
// а невнятным несовпадением подсказок. Поэтому бюджету дан большой запас (PARSE_BUDGET_MS),
// а таймаут файла поднят так, чтобы оставаться заведомо больше бюджета. Дефолтный таймаут
// проекта намеренно не трогаем: реально медленный тест должен оставаться заметным.
