...
хэша, что и у Xray). Как и с `xray`, без бинаря (обычный случай при локальной разработке) кнопка
«Проверить ядром» просто недоступна, а не отвечает ошибкой.

Отчёт проверки Mihomo всегда несёт оговорку: ядро смотрело не ваш документ дословно. Настоящих
