...
- **Шаблоны подписки.** Редактор правит и второй раздел панели — шаблоны подписки (тип
  ...
  видны узлами графа наравне со статическими выходами. Остальные типы шаблонов (Mihomo, Clash,
  Stash и прочие) видны в списке, но правятся в панели: их содержимое лежит не в `templateJson`.
